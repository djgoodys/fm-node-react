        ...
        <table id="tblNavigation">
          <tbody>
            <tr id="trButtons">
              <td id="tdMenu"></td>
              <td>
                  <button className="myButton" id="btnUnits" name="btnUnits" type="button" data-bs-toggle="dropdown" aria-expanded="false" title="View unit list" onClick={()=>navigate("/fmnodereact/equipment")}>Units</button>
              </td>
              ...
              <td>
                <button id="btnGoToTasks" name="btnGoTasks" className="myButton" data-toggle="tooltip" data-placement="top" title="View tasks" onClick={()=>navigate("/fmnodereact/tasks")}>Tasks</button>
              </td>
              <td>
                <button className="myButton" id="btnFilters" name="btnfilters" data-toggle="tooltip" data-placement="top" title="Filter Inventory Control" onClick={()=>navigate("/fmnodereact/filters")}>Filters</button>
              </td>
              <td>
